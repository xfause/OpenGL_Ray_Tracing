...
int main(int argc, char** argv) {
    ...
    readObj("../OpenglRayTracing/models/quad.obj", triangles, m, getTransformMatrix(
        vec3(0, 0, 0), 
        vec3(0, -1.4, 0), 
    ...
    std::string pass2ShaderPath = "../OpenglRayTracing/shaders/pass2.fsh";
    std::string pass3ShaderPath = "../OpenglRayTracing/shaders/pass3.fsh";
    std::string vshaderPath = "../OpenglRayTracing/shaders/vshader.vsh";
