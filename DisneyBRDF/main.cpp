...
int main(int argc, char** argv) {
    ...
    //m.roughness = 0.0;
    //readObj("../DisneyBRDF/models/sphere2.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(-1.5, 0, 0), vec3(1,1,1)), true);

    //m.baseColor = vec3(0.5, 1, 0.5);
    //m.roughness = 0.5;
    //readObj("../DisneyBRDF/models/sphere2.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0, 0, 0), vec3(1, 1, 1)), true);
    ...
    //m.roughness = 0.0;
    //m.subsurface = 0.0;
    //readObj("../DisneyBRDF/models/bunny.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(-0.5, -1.5, 0), vec3(2.0, 2.0, 2.0)), true);

    //m.baseColor = vec3(0.5, 1, 0.5);
    //m.roughness = 0.0;
    //m.subsurface = 1.0;
    //readObj("../DisneyBRDF/models/bunny.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(1.5, -1.5, 0), vec3(2.0, 2.0, 2.0)), true);
    ...
    //m.subsurface = 1.0;
    //m.specular = 1.0;
    //readObj("../DisneyBRDF/models/bunny.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0, -1.5, 0), vec3(2.0, 2.0, 2.0)), true);
    ...
    //m.specular = 0.5;
    //m.metallic = 0.9;
    //readObj("../DisneyBRDF/models/sphere2.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0, -1, 0), vec3(1, 1, 1)), true);

    //float len = 13.0;
    //m.metallic = 0.7;
    //m.roughness = 0.3;
    //m.anisotropic = 1.0;
    //readObj("../DisneyBRDF/models/quad.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0, -1.5, 0), vec3(len, 0.01, len)), false);

    //m.baseColor = vec3(1, 1, 1);
    //m.emissive = vec3(20, 20, 20);
    //readObj("../DisneyBRDF/models/quad.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0.0, 1.48, -0.0), vec3(1.7, 0.01, 1.7)), false);
    ...
    if (showBackground) {
        ...
        bool r = HDRLoader::load("../DisneyBRDF/HDR/peppermint_powerplant_4k.hdr", hdrRes);
        hdrMap = getTextureRGB32F(hdrRes.width, hdrRes.height);
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB32F, hdrRes.width, hdrRes.height, 0, GL_RGB, GL_FLOAT, hdrRes.cols);
    }

    //pipline
    std::string pass1ShaderPath = "../DisneyBRDF/shaders/pass1.fsh";
    std::string pass2ShaderPath = "../DisneyBRDF/shaders/pass2.fsh";
    std::string pass3ShaderPath = "../DisneyBRDF/shaders/pass3.fsh";
    std::string vshaderPath = "../DisneyBRDF/shaders/vshader.vsh";
